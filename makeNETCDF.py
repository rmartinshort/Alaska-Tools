...
#file contaning all the earthquake information for Alaska - magnitude 3+ 
########################################
...
def extractdepthslice(infilelines,radius,makefiles=False):
...
if __name__ == '__main__':
	...
	# #This will be the grid in the z direction
	...
	# rootgrp = Dataset('testcoords3D.nc','w',format='NETCDF4')
	...
	# for i in range(nz):
	# 	radius = tmpradius[i]
	# 	LONS,LATS,VALS = extractdepthslice(lines,str(radius))
